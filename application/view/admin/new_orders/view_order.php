...
<?= $address['aname'] ?><br>
    <?= $address['address'].",".$address['pin_code']."<br>".$address['city'].",".$address['state'].",".$address['mobile'] ?>
  </div>
</div>
...
<div class="row alert alert-warning">Please Print this reciept and upload it to the previous menu.</div>
