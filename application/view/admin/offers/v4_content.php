            ...
            <div class="table-responsive py-4">
              <table class="table table-striped table-bordered file-export">
                               <thead>
                                   ...
                                   $sql="SELECT * FROM `tbl_offer_master`";
                                   $i=1;
...
if($row['type']=='0')
                                  ...
                                  echo $status;
                                        ...
                                        <td><?= $row['off_text'] ?></td>
                                        <td>
                                          <a class="btn btn-danger btn-sm" href="<?php echo $call_config->base_url().'application/modal/admin/delete_offer.php?id='.$row['id'] ?>">Delete</a>
                                        </td></tr>
<?php } ?>
...
<form method="POST" enctype="multipart/form-data" action="<?php echo $call_config->base_url() ?>application/modal/admin/add_offer.php">
...
<select style="display: none;" class="form-control" id="keyword_select" name="keyword_select">
  <?php
$row=$call_config->get_all("SELECT * FROM `tbl_sub_category_master`");
foreach ($row as $key) {
...
<input type="text" required name="off_text" class="form-control">
<label>Title</label>
<input type="text" required name="title" class="form-control">
<label>Description</label>
<textarea required class="form-control" name="description" placeholder="Enter Your Offer Description"></textarea>
</div>
