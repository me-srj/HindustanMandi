        ...
        <div class="header-body">
          <div class="row align-items-center py-4">
            ...
            <div class="col-lg-6 col-5 text-right">
                 <a class="btn btn-neutral" href="<?= $call_config->base_url() ?>application/view/admin/message_orders/all.php">All</a>
            </div>
          </div>
...
foreach ($message as $key) {
  ...
  ?>
    ...
    <a target="_blank" class="btn btn-success float-right"  href="<?= $call_config->base_url() ?>application/view/admin/create_order/?cid=<?= $Customer['id'] ?>&id=<?php echo $key['id'] ?>&type=tbl_message_order_master&aid=<?= $key['addressid'] ?>">Create Order</a>
  </div>
...
<h4 class="modal-title " id="myModalLabel17">Reject Message Order</h4>
<button type="button" class="close" data-dismiss="modal" aria-label="Close">
<span aria-hidden="true">&times;</span>
</button>
</div>
<form method="POST" action="<?= $call_config->base_url() ?>application/modal/admin/reject_message_order.php">
