...
$pre_id=mysqli_escape_string($call_config->con,$_POST['pre_id']);
...
$call_config->IDU("UPDATE `tbl_address_master` SET `status`='0' WHERE `id`='".$pre_id."'");
	$call_config->msg("Success!!","Address Edited Successfully!!","success","user/profile/address.php","");
}
else
{
$call_config->msg("Failed!!","Failed to edit address!!","info","user/profile/","");
}
}
else
{
